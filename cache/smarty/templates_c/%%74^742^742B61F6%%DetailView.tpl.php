<?php /* Smarty version 2.6.11, created on 2023-02-23 04:21:27
         compiled from cache/modules/A_Orders/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/A_Orders/DetailView.tpl', 33, false),array('function', 'counter', 'cache/modules/A_Orders/DetailView.tpl', 38, false),array('function', 'sugar_translate', 'cache/modules/A_Orders/DetailView.tpl', 47, false),array('modifier', 'strip_semicolon', 'cache/modules/A_Orders/DetailView.tpl', 48, false),array('modifier', 'escape', 'cache/modules/A_Orders/DetailView.tpl', 132, false),array('modifier', 'url2html', 'cache/modules/A_Orders/DetailView.tpl', 132, false),array('modifier', 'nl2br', 'cache/modules/A_Orders/DetailView.tpl', 132, false),)), $this); ?>
...
" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='A_Orders'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='A_Orders'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='A_Orders'; _form.return_action.value='ListView'; _form.action.value='Delete'; if(confirm('<?php echo $this->_tpl_vars['APP']['NTC_DELETE_CONFIRMATION']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='A_Orders'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
<div id="A_Orders_detailview_tabs"
>
<div >
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['description']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPTION','module' => 'A_Orders'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
